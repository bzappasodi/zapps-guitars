...
import * as api from "../../../api/amplifierInventoryService";
...
export function* watchAmplifierInventoryDisplay() {
  yield takeEvery(
    constants.types.AMPLIFIER_INVENTORY_DISPLAY,
    executeAmplifierInventoryDisplay
  );
}
...
export function populateAmplifierInventoryResultsToState(amplifiers) {
  return {
    type: actionTypes.AMPLIFIER_INVENTORY_ACTION_TYPE
...
export default function* sagas() {
  return yield all([watchAmplifierInventoryDisplay()]);
}
