...
export function* watchGuitarInventoryDisplay() {
  yield takeEvery(
    constants.types.GUITAR_INVENTORY_DISPLAY,
    executeGuitarInventoryDisplay
  );
}
...
export function populateGuitarInventoryResultsToState(guitars) {
  return {
    type: actionTypes.GUITAR_INVENTORY_ACTION_TYPE
      .ADD_GUITAR_INVENTORY_TO_STATE,
    guitars: guitars,
  };
}
...
export default function* sagas() {
  return yield all([watchGuitarInventoryDisplay()]);
}
